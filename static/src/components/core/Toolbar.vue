<template>
  <v-toolbar id="core-toolbar" flat prominent style="background: #eee; margin-top: 0px;">
    ...
    <v-toolbar-items>
      <v-flex align-center layout py-2>
        ...
        <v-icon color="tertiary" href="/">mdi-view-dashboard</v-icon>
        <v-icon color="tertiary">mdi-bell</v-icon>
        -->
        <v-btn large color="purple" href="/logout">Logout</v-btn>
        <!--
